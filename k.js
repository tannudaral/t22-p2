...
function state(s){
  ...
  if (s==="init"){
    ...
    wrapper.addEventListener('mouse',function(e){
...
window.onload = function() {
  state("init");
  // followMe("init");https://srv.buysellads.com/ads/click/x/GTND42JICKBDC23LF67LYKQNCK7ICKQUF6ADTZ3JCY7ICK7WCTYDV2JKFTBIE2JYCESIVK7IF67I6KQMC6ADK2JKC6SDCK7WCKADEK3EHJNCLSIZ
}